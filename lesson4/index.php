<!--Работаем на сайте https://paiza.io/
-->
        ...
        <div class="w3-white w3-text-grey w3-card-4">
          <div class="w3-display-container">
            ...
            <div class="w3-display-bottomleft w3-container w3-text-black">
              <h2></i><?php echo $name; ?></h2>
            </div>
          </div>
          <div class="w3-container">
            <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i><?php echo $profession; ?></p>
            <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i></i><?= $city; ?></p>
            <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i></i><?php echo $email; ?></p>
            <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i></i><?php echo $tel; ?></p>
